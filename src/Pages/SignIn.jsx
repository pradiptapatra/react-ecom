...
const SignIn = () => {
    return (
        <>
            <section class="section signInPage">
                ...
                <div class="container">
                    <div class="box card p-3 shadow border-0">
                        ...
                        <form class="mt-3">
                            ...
                            <a class="border-effect cursor txt">Forgot Password?</a>
                            ...
                            <p class="txt">Not Registered? <a class="border-effect" href="/signUp">Sign Up</a></p>
